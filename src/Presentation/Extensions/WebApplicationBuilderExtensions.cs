namespace Amper3.Presentation.Extensions;
    ...
    public static WebApplicationBuilder ConfigureApplicationBuilder(this WebApplicationBuilder builder)
    {
        ...
        _ = builder.Services.AddSwaggerGen(options =>
        {
            options.SwaggerDoc("v1",
                ...
                {
                    Version = "v1",
                    Title = $"Amper3 API - {ti.ToTitleCase(builder.Environment.EnvironmentName)}",
                    Description = "An example to share an implementation of Minimal API in .NET 6.",
                    Contact = new OpenApiContact
                    {
                        Name = "Amper3 API",
                        Email = "amper3@stphnwlsh.dev",
                        Url = new Uri("https://github.com/stphnwlsh/amper3")
                    },
                    License = new OpenApiLicense
                    {
                        Name = "Amper3 API - License - MIT",
                        Url = new Uri("https://opensource.org/licenses/MIT")
                    },
                    TermsOfService = new Uri("https://github.com/stphnwlsh/amper3")
                });
