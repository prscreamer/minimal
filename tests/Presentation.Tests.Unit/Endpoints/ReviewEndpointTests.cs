namespace Amper3.Presentation.Tests.Unit.Endpoints;

using System.Threading.Tasks;
using Amper3.Application.Authors.Entities;
using Amper3.Application.Common.Exceptions;
using Amper3.Application.Movies.Entities;
using MediatR;
